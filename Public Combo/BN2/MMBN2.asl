...
split
{
    ...
    {
        if (current.Progress == 72 && current.MainArea == 2 && current.SubArea == 4 && old.PETDing == 0 && current.PETDing > 10000)
        {
            print("Final Ding Split");
            return true;
        }
